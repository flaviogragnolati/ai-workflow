...
description: "Render approved Quasar report content into traceable Markdown, editable DOCX, and matching PDF documents. Use when a baselined report source must be mapped into written channels, branded consistently, validated for content and layout, reconciled after manual edits, and registered without acquiring semantic authority."
---
...
Read the [cross-workflow contract](../../00-cross-workflow-contract.md), [report-source schema](../../schemas/report-source.schema.yaml), and the general identity, typography, accessibility, confidentiality, and source rules in [Quasar presentation identity](../generate-quasar-deck/references/identidad-visual.md). Do not apply slide-specific canvas or layout patterns to documents.
...
Keep Markdown and DOCX editable, but not authoritative. Return semantic edits to `reporting-source-design`; after approval, regenerate every affected document and deck channel.
