...
description: "Audit a codebase, module, feature, or release candidate against generic engineering standards, the project's versioned technical foundation, repository conventions, and applicable official technology guidance. Use for evidence-based integral quality assessment; not for one diff or for applying fixes."
---

# Codebase review

Produce a broad, evidence-backed quality audit without changing code. Use `code-review` for one diff and `review-code-comments` for comment quality alone.
