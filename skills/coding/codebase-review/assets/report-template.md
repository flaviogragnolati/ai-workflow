...
Close the subsection with the candidate you'd tackle first and why, and note that exploring a candidate further (interface design, constraints, what sits behind the seam) is a job for the `design-grill` flow — not for this report.
