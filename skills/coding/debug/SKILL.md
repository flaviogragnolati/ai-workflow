---
name: debug
description: "Diagnose and fix reproducible or hard failures in a codebase using evidence, ranked hypotheses, focused tests, and proportional project validation. Use when behavior is broken, failing, slow, flaky, or incorrect and the cause is not already confirmed."
---
