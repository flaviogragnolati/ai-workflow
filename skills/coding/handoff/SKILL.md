---
name: handoff
description: "Create a structured, redacted workspace handoff that lets a fresh agent continue without conversation history. Use when pausing work, changing sessions, or transferring a task with decisions, evidence, current state, risks, blockers, artifacts, and next steps."
---
