...
description: "Review changed or relevant source comments and docstrings for accuracy, usefulness, clarity, and maintainability without changing program behavior. Use alone for comment audits or as the comment axis of the post-implementation mini review."
---
...
6. Return findings separately from the technical `code-review` axis.

When used after `implement`, the implementer records the result in the original durable execution record.
