...
description: "Run a short alignment for a small, well-contained change and create a reduced durable implementation plan. Use for a component, page, function, or simple flow that needs no more than five material questions; escalate when scope spans modules or architecture. Part of the Quasar AI delivery skills."
---
...
5. Stop and escalate to `q-code-grill-feature` or `q-code-grill-design` if the work expands.
